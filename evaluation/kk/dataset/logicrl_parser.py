...
def compute_score(solution_str: str, 
                 data_item: Dict[str, str]):
    """Computes comprehensive score for model response.
    Args:
        solution_str: Raw model response string
        data_item: Dictionary of the data item
    ...
    solution_text = data_item.get('solution_text_format', '')
    ...
    if answer_text:
        ...
        if pred_status:
            ...
            if pred_status == gt_status:
                return 1, pred_status, gt_status
            else:
                return 0, pred_status, gt_status
        else:
            return 0, " Parse failure", gt_status
    return 0, " Parse failure", gt_status
