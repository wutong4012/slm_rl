...
for name in aime2024 gpqa_diamond; do

  for ((i=140; i<150; i+=20)); do

        python3 -m verl.trainer.main_ppo \
            algorithm.adv_estimator=reinforce_plus_plus \
            data.train_files=dataset/orz/train_debug.parquet \
            data.val_files=dataset/orz/test_$name.parquet \
            ...
            actor_rollout_ref.rollout.min_tokens=0 \
            ...
            trainer.experiment_name='grpo_qwen1.5B-orz-test' \
            ...
            trainer.resume_mode=/data/wutong/reft-exp/experiments/checkpoints/logic_rl-orz/grpo_qwen1.5B-orz-exp6/global_step_$i
